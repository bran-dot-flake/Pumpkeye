...
var selector_sprite	= global.sprites.selector;
...
draw_text(label_main_x[0], ps.y, "PLAY");
...
// Draw the label
draw_text(label_main_x[1], ps.y, "SETTINGS");
ps.y += label_sep + str_h;
...
for (var i = 0; i < array_length(options[1]); i++) {
	...
	var selct = selected_column == 1 and i == selected_row and selected_level <= 0;
	var xoff = selct ? x_offset : 0;
